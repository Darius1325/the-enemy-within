...
Game_BattlerBase.prototype.addWeapon = function (weaponId) {
    ...
    this.weapons.push({
        ...
        isReloadable: rangedWeapon && (rangedWeapon.group === 'BLACKPOWDER' ||
            rangedWeapon.group === 'ENGINEERING' ||
            rangedWeapon.group === 'CROSSBOW'),
        ammo: 0,
        ammoType: undefined // Ammo ID
    });
    this.weapons = this.weapons.sort((a, b) => TEW.WEAPON_IDS.indexOf(a.id) - TEW.WEAPON_IDS.indexOf(b.id));
};
...
Game_BattlerBase.prototype.sortArmors = function () {
    this.armors = this.armors.sort((a, b) => TEW.ARMOR_IDS.indexOf(a) - TEW.ARMOR_IDS.indexOf(b));
};
Game_BattlerBase.prototype.sortEquippedArmors = function () {
    this.equippedArmors = this.equippedArmors.sort((a, b) => TEW.ARMOR_IDS.indexOf(a) - TEW.ARMOR_IDS.indexOf(b));
};
// Ammo
