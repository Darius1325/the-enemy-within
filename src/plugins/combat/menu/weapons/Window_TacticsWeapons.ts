...
import HalfWindow_TacticsList, { IHalfWindow_TacticsList } from "../base/HalfWindow_TacticsList";
...
export interface IWindow_TacticsWeapons extends IHalfWindow_TacticsList {
...
export default Window_TacticsWeapons.prototype = Object.create(HalfWindow_TacticsList.prototype);
...
Window_TacticsWeapons.prototype.setActor = function(actor: Game_Actor) {
...
Window_TacticsWeapons.prototype.drawItem = function(index: number) {
...
Window_TacticsWeapons.prototype.weaponFromIndex = function(index: number) {
...
Window_TacticsWeapons.prototype.select = function(index: number) {
    this._index = index;
    if (this._index >= 0) {
